...
class ArtistData extends Model
{
    ...
    protected $fillable = ["artist_id","hourly_rate","specialty","specialty2","specialty3","specialty4","specialty5","years_in_trade","walk_in_welcome","certified_professionals","consultation_available",
        ...
        "shop_logo","shop_percentage","blood_borne","shop_email","shop_name","shop_address","wont_do","unique_offerings","cc_fees","cc_fees_percentage"
    ];
}
