...
class ExpensesController extends Controller
{
    ...
    public function getExpenses(Request $request)
    {
        ...
        $expense = $query->where('isarchive', 0)->orderBy('transaction_date', 'desc')->paginate(10); // Change 10 to the number of records per page
    ...
    public function getExpensesArchive(Request $request)
    {
        ...
        // Fetch paginated expenses
        $expense = $query->where('isarchive', 1)->orderBy('transaction_date', 'desc')->paginate(10); // Change 10 to the number of records per page
