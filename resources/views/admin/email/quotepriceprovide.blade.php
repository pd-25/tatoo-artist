        ...
        <tr>
            <td style="padding:20px;">
                ...
                <p style="text-align:center; margin:30px 0;">
                    <a href="{{ url('https://tattoome.net/' . urlencode($artist_name)) }}/" style="background:#28a745; color:#fff; text-decoration:none; padding:12px 20px; border-radius:5px; font-size:16px;">
                        Book Appointment
                    </a>
                </p>
