                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="design" placeholder="Design"
                                            value="{{ old('design') }}" required>
                                    ...
                                    <div class="form-group">
                                        <label>CC Fees</label>
                                        <input type="number" class="form-control" name="fees" placeholder="Fees" value="0"
                                            readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="customers_name"
                                            placeholder="Customer Name" value="{{ old('customers_name') }}" required>
                                    ...
                                    <div class="form-group">
                                        <label>Tips</label>
                                        <input type="number" class="form-control" name="tips" placeholder="Tips"
                                            value="{{ old('tips') }}">
