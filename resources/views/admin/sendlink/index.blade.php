...
<body>
    <form id="signatureForm" action="{{ route('admin.userformsubmit') }}" name="userform" method="POST"
        ...
        <div class="container">
            ...
            <div class="row text-justify">
                <p>
                    I am signing this agreement to induce {{$artistinfo->name}} (THT) and the Subcontracted Tattoo
                    Artist (STA) to modify my tattoo and/o tattoo my person. In consideration of doing so, I hereby
                    release THT and its
                ...
                <p>
                    I am promising to disclose on this medical form and to my STA if I have any of the following
                    conditions, including but not limited to, a history o Herpes Infection at the proposed procedure
                    site, Diabetes, Allergic
                    reactions to latex or antibiotics, Hemophilia or other bleeding disorders, o Cardiac Vascular
                    Disease, Epilepsy, Keloiding (excessive scarring), AIDS or HIV, AIDS Related Complex (ARC), under
                    the influence of drugs 01
                    alcohol, and Swelling, Lumps, or signs of irritation of the area to be tattooed or any related
                    health risks. I will disclose if I am currently using medication, including being prescribed
                    antibiotics prior to dental or
                    surgical procedures. Additionally, I will share if other risk factors for bloodborne pathogen
                    exposure exist in my daily life. To my knowledge I do not have any physical, mental, or medical
                    ...
                    done at this time. Some of these conditions include pregnancy and but not limed to a history of
                    severe asthma attacks
                </p>
                <p>
                    The procedure of getting a tattoo means the insertion of pigment in human skin tissue by piercing it
                    with a needle. It is permanent. I am aware that tattooing is a hazardous activity, and am
                    voluntarily participating
                    with knowledge of the risks involved, which include infection or other injury. I understand it can
                    be expensive and painful to remove a tattoo and that the process is not always successful and may
                    result in scarring.
                    Additional information regarding this procedure are furnished in THT's Post Procedure Instructions.
                    With full knowledge of the dangers and risks involved I hereby agree and accept all risks of any
                    kind or nature. Being
                    of sound mind and body, I hereby release any and all persons representing THT from all
                ...
                <p>
                    ...
                    agents, employees, and representatives of THT. I further agree not to file any suit, claim, or
                    action for any damages,
                    demands, rights, or causes of action for any nature, including but not limited to injury, maiming,
                    property damage or death to myself or any other person arising from my decision to have tattoo work
                    done by THT, its
                    owners, agents, employees or representatives harmless of all damages, actions, causes of action,
                    claim judgements, cost of litigation, attorney fees, and any and all costs and expenses which may
                    arise from my decision to
                    have tattoo work done by THT
                </p>
                <p>
                    I agree to leave the premises of THT promptly upon request by any owner, agent, employee, or
                    representative of THT for any reason whatsoever. I agree these waivers and releases pertain to and
                    are directed to protect THT.
                </p>
            </div>
            <div class="row">
