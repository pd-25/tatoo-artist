    ...
    <body>
        <div class="container">
            ...
            <div class="row text-justify">
                ...
                <p>
                    I am promising to disclose on this medical form and to my STA if I have any of the following conditions, including but not limited to, a history o Herpes Infection at the proposed procedure site, Diabetes, Allergic
                    reactions to latex or antibiotics, Hemophilia or other bleeding disorders, o Cardiac Vascular Disease, Epilepsy, Keloiding (excessive scarring), AIDS or HIV, AIDS Related Complex (ARC), under the influence of drugs 01
                    alcohol, and Swelling, Lumps, or signs of irritation of the area to be tattooed or any related health risks. I will disclose if I am currently using medication, including being prescribed antibiotics prior to dental or
                    surgical procedures. Additionally, I will share if other risk factors for bloodborne pathogen exposure exist in my daily life. To my knowledge I do not have any physical, mental, or medical impairments or disability
                    which might affect my well being as a direct or indirect result from my decision to have tattoo work done at this time. Some of these conditions include pregnancy and but not limed to a history of severe asthma attacks
                </p>
                <p>
                    The procedure of getting a tattoo means the insertion of pigment in human skin tissue by piercing it with a needle. It is permanent. I am aware that tattooing is a hazardous activity, and am voluntarily participating
                    with knowledge of the risks involved, which include infection or other injury. I understand it can be expensive and painful to remove a tattoo and that the process is not always successful and may result in scarring.
                    Additional information regarding this procedure are furnished in THT's Post Procedure Instructions. With full knowledge of the dangers and risks involved I hereby agree and accept all risks of any kind or nature. Being
                    of sound mind and body, I hereby release any and all persons representing THT from all responsibility and liability for any consequences
                </p>
                <p>
                    ...
                    demands, rights, or causes of action for any nature, including but not limited to injury, maiming, property damage or death to myself or any other person arising from my decision to have tattoo work done by THT, its
                    owners, agents, employees or representatives harmless of all damages, actions, causes of action, claim judgements, cost of litigation, attorney fees, and any and all costs and expenses which may arise from my decision to
        ...
        <form action="{{ route('admin.userformsubmit') }}" name="userform" method="POST" enctype="multipart/form-data">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="container">
                            ...
                            <div class="row" style="padding-right: 25px;">
                                <div class="col-md-10">
                                    <p>Are you allergic to any know materials or medications (or antibiotics) resulting in hives, asthma, eczema, etc.?</p>
                                </div>
                                <div class="col-md-1">
                                    <label class="radio-container">
                                        <input type="radio" name="are_you_allergic_to_any_know_materials" value="1" checked />
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="row" style="padding-right: 25px;">
                                <div class="col-md-10">
                                    <p>Any risk factors from work or lifestyle, that lead to exposure for bloodborne pathogens?</p>
                                </div>
                                <div class="col-md-1">
                                    <label class="radio-container">
                                        <input type="radio" name="any_risk_factors_from_work_or_lifestyle" value="1" checked />
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="cardiac_valve_disease" type="checkbox" value="1" id="1"/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="high_blood_pressure" type="checkbox" value="1" id="1"/>
                                        <label class="form-check-label" for="1">
                                            High Blood Pressure
                                        </label>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="respiratory_disease" type="checkbox" value="1" id="1"/>
                                        <label class="form-check-label" for="1">
                                            Respiratory Disease
                                        </label>
                                    </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="tumors_or_growths" type="checkbox" value="1" id="1"/>
                                        <label class="form-check-label" for="1">
                                            Tumors or Growths
                                        </label>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="hemophilia" type="checkbox" value="1" id="1"/>
                                        <label class="form-check-label" for="1">
                                            Hemophilia
                                        </label>
                                    </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="liver_disease" type="checkbox" value="1" id="1"/>
                                        <label class="form-check-label" for="1">
                                            Liver Disease
                                        </label>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="bleeding_disorder" type="checkbox" value="1" id="1"/>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="kidney_disease" type="checkbox" value="1" id="1"/>
                                        <label class="form-check-label" for="1">
                                            Kidney Disease
                                        </label>
                                    </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="exposure_to_aids" type="checkbox" value="1" id="1"/>
                                        <label class="form-check-label" for="1">
                                            Exposure to AIDS
                                        </label>
                                    </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" name="venereal_disease" type="checkbox" value="1" id="1"/>
                                        <label class="form-check-label" for="1">
                                            Venereal Disease
                                        </label>
                                    </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-8">
                                    <div class="form-check">
                                        <input class="form-check-input" name="herpes_infection_at_proposed_procedure_site" type="checkbox" value="1" id="1" />
                                        <label class="form-check-label" for="1">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" name="todaysdate" class="form-control uppercase" id="basic-url" aria-describedby="basic-addon3" required/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon3">Birth Date</span>
                                        <input type="date" name="birthdate" class="form-control uppercase" id="basic-url" aria-describedby="basic-addon3" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea class="form-control" name="address" id="exampleFormControlTextarea1" rows="3" aria-describedby="basic-addon3" placeholder="Street,City,State,ZIP...." required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="stateid" class="form-control" id="basic-url" aria-describedby="basic-addon3" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="p-1">
                                        Your signature declares your understanding and agreement of this Informed Consent, truthfulness in response of your medical history, and acknowledgment of being 18 years of age or older. Additionally,
                                        affirmation that you have received your Post Procedure Instructions and have had opportunity to have any and all questions regarding the procedure answered.
                                    </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="signatureOption" class="form-label">Choose Signature Option</label>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-sm" name="driving_licence_front" id="formFileSm" type="file" accept="image/*" onchange="readURL(this,'dl-front');" />
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-sm" name="driving_licence_back" id="formFileSm" type="file" accept="image/*" onchange="readURL(this,'dl-back');" />
                ...
                <div class="row mt-5">
                    <p class="text-center">This intellectual property belongs to the owner of THT and may not be copied without written consent from the author.</p>
                </div>
            </div>
