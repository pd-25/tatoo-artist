...
<div class="modal fade show" id="viewQuoteModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form id="quoteForm" action="" method="POST" enctype="multipart/form-data" class="modal-content animated flipInY">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h6><i class="fa fa-clone pr-1"></i>Provide Price<span class="text-danger">*</span></h6>
                        <input type="number" class="form-control" id="provide_price" name="provide_price" placeholder="Provide your price" value="{{ $quote->provide_price ?? '' }}" required>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-success">Provide Price</button>
