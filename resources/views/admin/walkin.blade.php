...
<div class="row justify-content-center">
    <div class="col-lg-11">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('artists.getWalkIn') }}" method="GET" enctype="multipart/form-data"
                    name="paymentform">
                    @csrf
        ...
        <div class="card card-css">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-md btn-success" style="    width: 100%; padding: 10px;" type="button"
                            onclick="Sendlink({{ $LoggedAuthId }})">Send</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table student-data-table m-t-20">
                        ...
                        <tbody style="text-align: center;">
                            ...
                            <tr data-id="{{ $quote->id }}">
                                <td><input type="checkbox" class="quoteCheckbox" value="{{ $quote->id }}">
                                </td>
                                <td>{{ $index + 1 }}</td>
