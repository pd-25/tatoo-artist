                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="specialty2" class="form-control">
                                                <option value="">Select style</option>
                                                @foreach ($styles as $style)
                                                <option value="{{ $style->id }}" {{ old('specialty2') == $style->id ? 'selected' : '' }}>
                                                    {{ $style->title }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="specialty3" class="form-control">
                                                <option value="">Select style</option>
                                                @foreach ($styles as $style)
                                                <option value="{{ $style->id }}" {{ old('specialty3') == $style->id ? 'selected' : '' }}>
                                                    {{ $style->title }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="specialty4" class="form-control">
                                                <option value="">Select style</option>
                                                @foreach ($styles as $style)
                                                <option value="{{ $style->id }}" {{ old('specialty4') == $style->id ? 'selected' : '' }}>
                                                    {{ $style->title }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="specialty5" class="form-control">
                                                <option value="">Select style</option>
                                                @foreach ($styles as $style)
                                                <option value="{{ $style->id }}" {{ old('specialty5') == $style->id ? 'selected' : '' }}>
                                                    {{ $style->title }}
                                                </option>
                                                @endforeach
                                            </select>
