                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="Burns">
                                                Burns
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Free Hand" id="Free Hand"
                                                {{ in_array('Free Hand', @$uniqueOfferings) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Free Hand">
                                                Free Hand
                                            </label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Hand Poke" id="Hand Poke"
                                                {{ in_array('Hand Poke', @$uniqueOfferings) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Hand Poke">
                                                Hand Poke
                                            </label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Mastectomy" id="Mastectomy"
                                                {{ in_array('Mastectomy', @$uniqueOfferings) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Mastectomy">
                                                Mastectomy
                                            </label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Melanated Skin" id="Melanated Skin"
                                                {{ in_array('Melanated Skin', @$uniqueOfferings) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Melanated Skin">
                                                Melanated Skin
                                            </label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Phalloplasty" id="Phalloplasty"
                                                {{ in_array('Phalloplasty', @$uniqueOfferings) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Phalloplasty">
                                                Phalloplasty
                                            </label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Scars" id="Scars"
                                                {{ in_array('Scars', @$uniqueOfferings) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Tebori" id="Tebori"
                                                {{ in_array('Tebori', @$uniqueOfferings) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Tebori">
                                                Tebori
                                            </label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Top Surgery" id="Top Surgery"
                                                {{ in_array('Top Surgery', @$uniqueOfferings) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Top Surgery">
                                                Top Surgery
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Vitiligo" id="Vitiligo"
                                                {{ in_array('Vitiligo', @$uniqueOfferings) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Vitiligo">
                                                Vitiligo
                                            </label>
                                        </div>
