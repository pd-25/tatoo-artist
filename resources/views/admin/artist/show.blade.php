...
@section('title', env('APP_NAME') . ' | Artist View')
@section('content')
                ...
                <div class="card-body">
                    <div class="basic-form">
                        ...
                        <div class="form-group">
                            ...
                            <input disabled type="hidden" name="latitude" id="latitude" value="{{ @$artist->latitude }}">
                            <input disabled type="hidden" name="longitude" id="longitude" value="{{ @$artist->longitude }}">
                            @error('address')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{-- <input disabled type="text" class="form-control" id="country" placeholder="Country" name="country"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select disabled name="specialty" class="form-control" value="{{ old('specialty') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select disabled name="walk_in_welcome" class="form-control">
                                        ...
                                        <option value="no"
                                            {{ @$artistData->walk_in_welcome == 'no' ? 'selected' : '' }}>
                                            No</option>
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select disabled name="parking" class="form-control" value="{{ old('parking') }}">
                                        <option selected disabled>select option</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Offensive or Hate Symbols" id="OffensiveHateSymbols" {{ in_array('Offensive or Hate Symbols', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="OffensiveHateSymbols">
                                            Offensive or Hate Symbols
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Copyrighted Material" id="CopyrightedMaterial" {{ in_array('Copyrighted Material', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="CopyrightedMaterial">
                                            Copyrighted Material
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Inappropriate Imagery" id="InappropriateImagery" {{ in_array('Inappropriate Imagery', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="InappropriateImagery">
                                            Inappropriate Imagery
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Eyes" id="Eyes" {{ in_array('Eyes', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="Eyes">
                                            Eyes
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Genitals" id="Genitals" {{ in_array('Genitals', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="Genitals">
                                            Genitals
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Inner Lips" id="InnerLips" {{ in_array('Inner Lips', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="InnerLips">
                                            Inner Lips
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Armpits" id="Armpits" {{ in_array('Armpits', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="Armpits">
                                            Armpits
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Bottom Of Foot" id="BottomOfFoot" {{ in_array('Bottom Of Foot', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="BottomOfFoot">
                                            Bottom Of Foot
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Palms" id="Palms" {{ in_array('Palms', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="Palms">
                                            Palms
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Toes" id="Toes" {{ in_array('Toes', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="Toes">
                                            Toes
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Breasts" id="Breasts" {{ in_array('Breasts', @$wontDo) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="Breasts">
                                            Breasts
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="wont_do[]" value="Gang Symbols" id="GangSymbols" {{ in_array('Gang Symbols', @$wontDo) ? 'checked' : '' }} disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Vegan Ink" id="Vegan Ink" {{ in_array('Vegan Ink', @$uniqueOfferings) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="Vegan Ink">
                                            Vegan Ink
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="unique_offerings[]" value="Cover Ups" id="Cover Ups" {{ in_array('Cover Ups', @$uniqueOfferings) ? 'checked' : '' }} disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select disabled name="mask_worn" class="form-control" value="{{ old('mask_worn') }}">
                                        <option selected disabled>select option</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select disabled name="bike_parking" class="form-control" value="{{ old('bike_parking') }}">
                                        <option selected disabled>select option</option>
                                        <option value="yes"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input disabled type="file" class="form-control" name="shop_logo"
                                        value="{{ old('shop_logo') }}">
                                    @error('shop_logo')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input disabled type="password" class="form-control" placeholder="password" name="password">
                                    @error('password')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        {{-- <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input disabled type="file" class="form-control" name="profile_image">
                                    @error('profile_image')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input disabled type="file" class="form-control" name="banner_image"
