                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="sex" id="male_radio" value="" @if(old('sex') == 'Male') checked @endif>
                                            <label class="form-check-label" for="sex">
                                                1) Male
                                            </label><br>
                                            <input type="radio" name="sex" id="female_radio" value="" @if(old('sex') == 'Female') checked @endif>
                                            <label class="form-check-label" for="sex" >
                                                2) Female
                                            </label><br>
                                            <input type="radio" name="sex" id="other_radio" value="" @if(old('sex') == 'Other') checked @endif>
                                            <label class="form-check-label" for="sex">
                                                3) Other
                                            </label>
